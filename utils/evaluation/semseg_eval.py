...
from utils.evaluation.semantic_segmentation import convert_pano_to_semseg, convert_poly_to_semseg
...
class SemSegEvaluator:
    ...
    def __init__(self, dataset, root_dir, maskPred=None, num_classes=20, gt_dir=None):
        """
    ...
    def evaluate(self):
        ...
        for i in tqdm(self.ids, desc='Calculating IoU ..'):
            ...
            if not os.path.exists(os.path.join(self.gt_dir, image_name)):
                continue
            pre_png = self.maskPred[i]
