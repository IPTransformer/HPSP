...
class HungarianMatcher(nn.Module):
    ...
    @torch.no_grad()
    def memory_efficient_forward(self, outputs, outputs_cls, targets, targets_cls):
    # def memory_efficient_forward(self, outputs, targets):
        ...
        for b in range(bs):
            ...
            out_prob = outputs_cls[b].softmax(-1)  # [num_queries, num_classes]
            out_mask = outputs[b]  # [num_queries, H_pred, W_pred]
            tgt_label= targets_cls[b]

            # tgt_ids = targets_cls[b]
            ...
            out_mask = out_mask.flatten(1)  # [batch_size * num_queries, H*W]            tgt_mask = tgt_mask[:, 0].flatten(1)  # [num_total_targets, H*W]
            ...
            cost_class = -out_prob[:, tgt_label[:tgt_ids]]
            #print(tgt_label)
    ...
    @torch.no_grad()
    def forward(self, outputs, outputs_cls, targets, targets_cls):
        ...
        """
        return self.memory_efficient_forward(outputs, outputs_cls, targets, targets_cls)
